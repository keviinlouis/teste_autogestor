...
return [
    ...
    */
    ...
    'not_equals'           => 'O :attribute não pode ser igual a :field',
    ...
    'between_composto'     => 'A concentração do composto :attribute está fora do valor mínimo ou do valor máximo.',
    ...
    */
    ...
    'custom' => [
        'email' => [
            'required_without' => 'O campo email é requerido',
        ],
        'senha' => [
            'required_without' => 'O campo senha é requerido',
        ],
        'facebook_id' => [
            'required_without' => 'O campo facebook id é requerido',
        ],
    ],
